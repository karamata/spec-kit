...
|----------------|---------|-------------|
| **CLI Tool Only** | `uv tool install specify-cli --force --from git+https://github.com/karamata/spec-kit.git` | Get latest CLI features without touching project files |
...
```bash
uvx --from git+https://github.com/karamata/spec-kit.git specify init --here --ai copilot
```
...
- **Review release notes:** Check [GitHub Releases](https://github.com/karamata/spec-kit/releases) for new features and breaking changes
