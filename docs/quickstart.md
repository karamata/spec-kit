...
```bash
uvx --from git+https://github.com/karamata/spec-kit.git specify init <PROJECT_NAME> --script ps  # Force PowerShell
uvx --from git+https://github.com/karamata/spec-kit.git specify init <PROJECT_NAME> --script sh  # Force POSIX shell
```
...
- Explore the [source code on GitHub](https://github.com/karamata/spec-kit)
